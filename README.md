# 🌿 Herbal Synergy Engine

![Python](https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white)

## 🚀 Overview
Computational engine for analyzing herbal plant synergies and interactions based on traditional knowledge databases.
...
## 🛠️ Technology Stack
*   **Core**: Expert System, Python, Botany
*   **Infrastructure**: Git, Local Environment

## 📦 Installation & Setup
```bash
# Clone the repository
git clone https://github.com/rodrigope12/israeli.git
