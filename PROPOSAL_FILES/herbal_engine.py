"""
Herbal Formula Engine - Custom MVP
Developed by: Rodrigo Perez Cordero (Physics Student & Python Developer)
Date: January 2026

Description:
Professional logic engine for medicinal plant formulation. Implements 
rigorous safety constraints, botanical family limits, and clinical 
synergy frameworks according to project requirements.
"""
